...
export interface IUserDocument extends Document {
  ...
  workspaces: Array<{ workspaceId: Types.ObjectId; name: string; joinedAt: Date }>;
  refreshToken: string;
...
export interface IAuthServiceInterface {
  ...
  addWorkspaceToUser(userId: string, workspaceId: string, name: string): Promise<void>;
  removeWorkspaceFromUser(userId: string, workspaceId: string): Promise<void>;
}
